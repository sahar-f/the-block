...
### Colors
- **Page**: #09090B · **Surfaces**: #141416 · **Surface hover**: #1A1A1E
- **Text**: #F4F4F5 (primary), #A1A1AA (secondary), #71717A (muted)
- **Accent**: #F59E0B amber (prices, CTAs) · **Accent hover**: #D97706
- **Accent glow**: shadow-amber-500/10 on focus, shadow-amber-500/5 on hover
...
- Card padding: p-4 · Grid gap: gap-4 cards, gap-6 sections
- Radius: rounded-lg (8px) on everything

### Responsive (mobile-first)
- Base: 1 column · `sm:` 2 columns · `lg:` 3 columns · `xl:` 3-4 columns

### Interactive States
- Card hover: scale-[1.02] shadow-xl shadow-amber-500/5 border-[#3F3F46] transition-all duration-200 ease-out
- Button hover: brightness-90 · Button disabled: opacity-50 cursor-not-allowed
- Focus: ring-2 ring-amber-500 ring-offset-2 ring-offset-[#09090B]
- Live auction: pulsing green dot (animate-pulse)
- Price display: JetBrains Mono, amber, prominent sizing
...
3. Building: frontend-design aesthetic direction + CLAUDE.md design tokens
4. Testing: TDD for bidding. Playwright MCP for visual verification.
